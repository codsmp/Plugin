...
public final class DefaultSpellCatalog implements SpellCatalog {
    ...
    public DefaultSpellCatalog() {
        ...
        register(new SpellDefinition("echo_call", "Echo Call", "spell_echo_call", binding("BONE", 3501), RelicTier.TIER_2, SpellEffectType.SUMMONER_CALL, List.of(RelicFamily.SUMMONER), 130, 3.0, 8.0, 120, "Summon an echo that points toward nearby untrusted players.", 28, 4));
