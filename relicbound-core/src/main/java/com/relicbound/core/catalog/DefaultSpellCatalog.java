...
public final class DefaultSpellCatalog implements SpellCatalog {
    ...
    public DefaultSpellCatalog() {
        ...
        register(new SpellDefinition("sky_leap", "Sky Leap", "spell_sky_leap", binding("FEATHER", 3301), RelicTier.TIER_1, SpellEffectType.MOBILITY_LEAP, List.of(RelicFamily.MOBILITY), 65, 2.0, 8.0, 0, "Launch upward and forward.", 18, 0));
