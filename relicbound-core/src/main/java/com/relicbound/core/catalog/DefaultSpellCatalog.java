...
public final class DefaultSpellCatalog implements SpellCatalog {
    ...
    public DefaultSpellCatalog() {
        register(new SpellDefinition("ember_burst", "Ember Burst", "spell_ember_burst", binding("BLAZE_POWDER", 2001), RelicTier.TIER_1, SpellEffectType.FIRE_CONE, List.of(RelicFamily.FIRE), 80, 3.5, 5.5, 0, "Blast nearby foes with a cone of flame.", 15, 0));
        ...
        register(new SpellDefinition("tide_salve", "Tide Salve", "spell_tide_salve", binding("PRISMARINE_SHARD", 2101), RelicTier.TIER_1, SpellEffectType.WATER_HEAL, List.of(RelicFamily.WATER), 70, 4.0, 5.0, 0, "Restore health and cleanse weak burn effects.", 18, 0));
        ...
        register(new SpellDefinition("thunder_lance", "Thunder Lance", "spell_thunder_lance", binding("LIGHTNING_ROD", 2201), RelicTier.TIER_1, SpellEffectType.STORM_STRIKE, List.of(RelicFamily.STORM), 85, 5.0, 15.0, 0, "Strike a target with chain lightning.", 22, 0));
        ...
        register(new SpellDefinition("dawn_aegis", "Dawn Aegis", "spell_dawn_aegis", binding("GLOWSTONE_DUST", 2401), RelicTier.TIER_1, SpellEffectType.LIGHT_SHIELD, List.of(RelicFamily.LIGHT), 90, 3.0, 6.0, 80, "Wrap yourself in radiant protection.", 25, 5));
        ...
        register(new SpellDefinition("starfall", "Starfall", "spell_starfall", binding("NETHER_STAR", 2701), RelicTier.TIER_3, SpellEffectType.CELESTIAL_FALL, List.of(RelicFamily.CELESTIAL), 180, 6.0, 10.0, 0, "Call down a beam from the heavens.", 40, 0));
        ...
        register(new SpellDefinition("veil_strike", "Veil Strike", "spell_veil_strike", binding("INK_SAC", 2901), RelicTier.TIER_1, SpellEffectType.SHADOW_BURST, List.of(RelicFamily.SHADOW), 85, 4.0, 5.5, 0, "Ambush with a shadow lash.", 16, 0));
        ...
        register(new SpellDefinition("trail_reveal", "Trail Reveal", "spell_trail_reveal", binding("COMPASS", 3201), RelicTier.TIER_1, SpellEffectType.EXPLORATION_REVEAL, List.of(RelicFamily.EXPLORATION), 70, 2.0, 20.0, 0, "Highlight points of interest nearby.", 12, 0));
        register(new SpellDefinition("sky_leap", "Sky Leap", "spell_sky_leap", binding("FEATHER", 3301), RelicTier.TIER_1, SpellEffectType.MOBILITY_LEAP, List.of(RelicFamily.MOBILITY), 60, 3.0, 10.0, 0, "Launch upward and forward.", 18, 0));
        register(new SpellDefinition("temper_touch", "Temper Touch", "spell_temper_touch", binding("ANVIL", 3401), RelicTier.TIER_2, SpellEffectType.CRAFTING_TEMPER, List.of(RelicFamily.CRAFTING), 100, 2.0, 5.0, 60, "Sharpen and empower tools briefly.", 22, 3));
        register(new SpellDefinition("echo_call", "Echo Call", "spell_echo_call", binding("BONE", 3501), RelicTier.TIER_2, SpellEffectType.SUMMONER_CALL, List.of(RelicFamily.SUMMONER), 130, 3.0, 8.0, 120, "Summon a spectral helper.", 28, 4));
