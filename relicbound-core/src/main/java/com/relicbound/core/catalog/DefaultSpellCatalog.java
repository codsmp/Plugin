...
public final class DefaultSpellCatalog implements SpellCatalog {
    ...
    public DefaultSpellCatalog() {
        ...
        register(new SpellDefinition("dawn_aegis", "Dawn Aegis", "spell_dawn_aegis", binding("GLOWSTONE_DUST", 2401), RelicTier.TIER_1, SpellEffectType.LIGHT_SHIELD, List.of(RelicFamily.LIGHT), 90, 3.0, 6.0, 120, "Wrap yourself in radiant protection.", 25, 5));
