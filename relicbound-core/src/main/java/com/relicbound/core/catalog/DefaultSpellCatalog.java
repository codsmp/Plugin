...
public final class DefaultSpellCatalog implements SpellCatalog {
    ...
    public DefaultSpellCatalog() {
        ...
        register(new SpellDefinition("root_bind", "Root Bind", "spell_root_bind", binding("OAK_SAPLING", 2501), RelicTier.TIER_1, SpellEffectType.NATURE_ROOT, List.of(RelicFamily.NATURE), 500, 3.0, 6.0, 60, "Anchor enemies in creeping roots.", 17, 2));
        ...
        register(new SpellDefinition("rewind_step", "Rewind Step", "spell_rewind_step", binding("CLOCK", 2801), RelicTier.ASCENSION_2, SpellEffectType.TIME_REWIND, List.of(RelicFamily.TIME), 140, 2.0, 8.0, 0, "Snap back to a safer rhythm.", 30, 0));
        ...
        register(new SpellDefinition("miners_blessing", "Miner's Blessing", "spell_miners_blessing", binding("IRON_PICKAXE", 3801), RelicTier.TIER_3, SpellEffectType.MINERS_BLESSING, List.of(RelicFamily.STONE), 180, 0.0, 0.0, 100, "Bless your mining with haste.", 20, 0));
